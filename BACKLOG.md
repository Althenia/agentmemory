...
## Completed: Derived-index v2 lifecycle bounds (2026-07-24)

1. [x] **Bound page work below 180 seconds.**
...
2. [x] **Audit lifecycle operations and maintain scope interfaces.**
...
3. [x] **Prove marker-only recovery against a real isolated engine.**
...
4. [x] **Restore a clean TypeScript check.**
...
Fresh-store use does not require old-corpus migration. The items above are resolved; the
targeted lifecycle suites, isolated real-engine integration test, full unit suite, build,
